...
hl.bind(mainMod .. " + N",                            hl.dsp.layout("swapcol l"))
hl.bind(mainMod .. " + M",                            hl.dsp.layout("swapcol r"))
...
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd(launchPrefix .. TERMINAL .. " --class spf_float -e spf"))
-- hl.bind(mainMod .. " + T",          hl.dsp.exec_cmd(launchPrefix .. EDITOR))
hl.bind(mainMod .. " + T",          hl.dsp.exec_cmd(launchPrefix .. "obsidian"))
